...
const STYLES = {
  'wechat-default': {
    name: '默认公众号风格',
    styles: {
      container: 'max-width: 740px; margin: 0 auto; padding: 20px 12px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 15px; line-height: 1.8 !important; color: #3f3f3f !important; background-color: #fff !important; word-wrap: break-word;',
      ...
      p: 'margin: 16px 0 !important; line-height: 1.8 !important; color: #3f3f3f !important; font-size: 15px;',
      ...
      li: 'margin: 8px 0; line-height: 1.8 !important; font-size: 15px;',
      blockquote: 'margin: 16px 0; padding: 10px 16px; background-color: #fafafa !important; border-left: 3px solid #999; color: #666 !important; line-height: 1.6 !important; font-size: 15px;',
  ...
  'latepost-depth': {
    name: '晚点风格',
    styles: {
      container: 'max-width: 700px; margin: 0 auto; padding: 40px 12px; font-family: -apple-system, BlinkMacSystemFont, "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", sans-serif; font-size: 16px; line-height: 1.8 !important; color: #1a1a1a !important; background-color: #fff !important; word-wrap: break-word;',
      h1: 'font-size: 28px; font-weight: 700; color: #1a1a1a !important; line-height: 1.3 !important; margin: 48px 0 28px; padding-left: 20px; border-left: 6px solid #009873; position: relative;',
      h2: 'font-size: 22px; font-weight: 600; color: #fff !important; line-height: 1.4 !important; margin: 40px 0 24px; padding: 16px 24px; background-color: #009873 !important; border-radius: 4px; position: relative;',
      h3: 'font-size: 18px; font-weight: 600; color: #009873 !important; line-height: 1.5 !important; margin: 35px 0 20px; padding-left: 16px; border-left: 4px solid #009873; position: relative;',
      h4: 'font-size: 17px; font-weight: 600; color: #1a1a1a !important; line-height: 1.5 !important; margin: 30px 0 16px; padding: 8px 12px; background-color: #f5f5f5 !important; border-left: 3px solid #009873;',
      h5: 'font-size: 16px; font-weight: 600; color: #333 !important; line-height: 1.5 !important; margin: 25px 0 14px;',
      h6: 'font-size: 15px; font-weight: 500; color: #666 !important; line-height: 1.5 !important; margin: 20px 0 12px;',
      p: 'font-size: 16px; margin: 20px 0 !important; line-height: 1.9 !important; color: #1a1a1a !important;',
      strong: 'font-weight: 700; color: #009873 !important; background-color: rgba(0, 152, 115, 0.08) !important; padding: 2px 6px; border-radius: 3px;',
      em: 'font-style: italic; color: #666 !important;',
      a: 'color: #009873 !important; text-decoration: none; border-bottom: 1px solid #009873;',
      ...
      blockquote: 'margin: 32px 0; padding: 20px 24px 20px 20px; background-color: #f5f5f5 !important; border-left: 4px solid #009873; color: #1a1a1a !important; font-size: 15px; line-height: 1.8 !important; position: relative; border-radius: 4px;',
      ...
      img: 'max-width: 100%; max-height: 600px !important; height: auto; display: block; margin: 32px auto; border-radius: 6px; border: 2px solid #009873; box-shadow: 0 4px 12px rgba(0, 152, 115, 0.12);',
      table: 'width: 100%; margin: 28px 0; border-collapse: collapse; font-size: 16px; border-radius: 6px; overflow: hidden;',
      th: 'background-color: #009873 !important; color: #fff !important; padding: 12px 16px; text-align: left; font-weight: 600; border: none;',
  ...
  'wechat-tech': {
    name: '技术风格',
    styles: {
      container: 'max-width: 740px; margin: 0 auto; padding: 20px; font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, sans-serif; font-size: 15px; line-height: 1.75 !important; color: #2c3e50 !important; background-color: #fff !important; word-wrap: break-word;',
      h1: 'font-size: 24px; font-weight: 700; color: #1a1a1a !important; line-height: 1.3 !important; margin: 36px 0 18px; padding: 0 0 12px; border-bottom: 3px solid #0066cc;',
      h2: 'font-size: 20px; font-weight: 700; color: #1a1a1a !important; line-height: 1.3 !important; margin: 32px 0 16px; padding-left: 16px; padding-top: 4px; padding-bottom: 4px; border-left: 5px solid #00a67d; background: linear-gradient(to right, #f0f9ff 0%, transparent 100%);',
      h3: 'font-size: 18px; font-weight: 600; color: #2c3e50 !important; line-height: 1.4 !important; margin: 28px 0 14px; padding-left: 12px; border-left: 3px solid #ff9800;',
      ...
      h6: 'font-size: 15px; font-weight: 600; color: #34495e !important; line-height: 1.4 !important; margin: 18px 0 9px;',
      p: 'margin: 18px 0 !important; line-height: 1.8 !important; color: #3a3a3a !important; font-size: 15px;',
      ...
      li: 'margin: 10px 0; line-height: 1.8 !important; color: #3a3a3a !important; font-size: 15px;',
      blockquote: 'margin: 16px 0; padding: 10px 16px; background-color: #f5f9fc !important; border-left: 3px solid #2196f3; color: #555 !important; line-height: 1.6 !important; font-size: 15px;',
      ...
      table: 'width: 100%; margin: 24px 0; border-collapse: collapse; font-size: 14px; box-shadow: 0 1px 4px rgba(0,0,0,0.1);',
